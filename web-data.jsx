...
const WEB_RESTAURANTS = [
  { id: 'r1', name: 'Köşe Ocakbaşı',  category: 'Kebap · Türk Mutfağı',    rating: 4.8, reviews: '1.2K', eta: '25-35 dk', etaMin: 25, fee: 0,  img: '🥩', popular: true,  promo: '%15 İndirim', tags: ['kebap'], selected: true,  payments: ['card','cash','doorcard','multinet','metropol','ticket'], minOrder: 150 },
  { id: 'r2', name: 'Napoli Pizzeria', category: 'Pizza · İtalyan',           rating: 4.7, reviews: '860',  eta: '20-30 dk', etaMin: 20, fee: 15, img: '🍕', popular: true,  promo: null,         tags: ['pizza'], selected: false, payments: ['card','cash','multinet','ticket'],            minOrder: 120 },
  { id: 'r3', name: 'Burger Atölyesi', category: 'Burger · Fast Food',        rating: 4.6, reviews: '2.1K', eta: '15-25 dk', etaMin: 15, fee: 0,  img: '🍔', popular: true,  promo: '2 Al 1 Öde', tags: ['burger'], selected: false, payments: ['card','cash','doorcard','multinet'],            minOrder: 100 },
  { id: 'r4', name: 'Yeşil Kâse',      category: 'Salata · Sağlıklı',        rating: 4.9, reviews: '540',  eta: '20-30 dk', etaMin: 20, fee: 10, img: '🥗', popular: false, promo: null,         tags: ['salad'], selected: true,  payments: ['card','multinet','metropol','ticket'],        minOrder: 90  },
  { id: 'r5', name: 'Tatlıcı Hacı',    category: 'Tatlı · Türk',             rating: 4.8, reviews: '1.5K', eta: '15-20 dk', etaMin: 15, fee: 0,  img: '🍰', popular: true,  promo: null,         tags: ['dessert'], selected: false, payments: ['card','cash'],                                minOrder: 80  },
  { id: 'r6', name: 'Kahve Durağı',    category: 'Kahve · İçecek',           rating: 4.5, reviews: '320',  eta: '10-15 dk', etaMin: 10, fee: 15, img: '☕', popular: false, promo: null,         tags: ['coffee'], selected: false, payments: ['card','multinet'],                            minOrder: 50  },
  { id: 'r7', name: 'Dragon Noodle',   category: 'Asya · Noodle',            rating: 4.4, reviews: '280',  eta: '25-35 dk', etaMin: 25, fee: 20, img: '🍜', popular: false, promo: null,         tags: ['asian'], selected: false, payments: ['card','cash'],                                minOrder: 110 },
  { id: 'r8', name: 'Deniz Balık',     category: 'Balık · Deniz Ürünleri',  rating: 4.7, reviews: '680',  eta: '30-40 dk', etaMin: 30, fee: 0,  img: '🐟', popular: false, promo: 'Yeni',       tags: ['balık'], selected: false, payments: ['card','multinet','metropol'],                 minOrder: 200 },
];
